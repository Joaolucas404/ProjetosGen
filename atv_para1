...
programa
{
	...
	funcao inicio()
	{
		...
		escreva("\nMedia salarial : R$ ", Mat.arredondar(mediaSalarios, 4))
		escreva("\nMedia de filhos é: ", Mat.arredondar(mediaFilhos, 4))
		escreva("\nMaior salario informado R$:", maiorSalario)
		escreva("\nPessoas com salario acima de 100: " ,totalP100/ 4* 100 , "%\n")
	}
}
/* $$$ Portugol Studio $$$ 
 * 
